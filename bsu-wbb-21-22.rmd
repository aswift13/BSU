...
- Utilize Data Visualization Tools/Techniques
- Apply Generalized Linear Models
- Predict Win Probability Based on Player/Team Statistics 
- Identify Team and Player Statistical Trends  

Aside from these basketball/statistical goals, Ill be using this markdown as an experimental template, a reference and re-work code do be as concise and efficient as possible. 
...
### Statistics of FG_A, EFG%, FT_A and FT%. 
...
# Data visualization (Graphs, plots and stuff) 
...
#data is reordered by total ARP
attach(tp)
